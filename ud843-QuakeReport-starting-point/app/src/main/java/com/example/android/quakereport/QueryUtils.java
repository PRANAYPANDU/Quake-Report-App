...
public final class QueryUtils {
    ...
    */
    ...
    public static ArrayList<EarthQuakeData> fetchEarthquakeData(String requestUrl) throws JSONException{
        // Create URL object
        ...
        ArrayList<EarthQuakeData> earthquake=null;
        try {
    ...
    public static ArrayList<EarthQuakeData> extractEarthquakes(String text) throws JSONException{
        ...
        for(int i=0;i<features.length();i++)
        {
            ...
            long dtime=prop.getLong("time");
            Date dateObject = new Date(dtime);
            SimpleDateFormat dateFormatter = new SimpleDateFormat("MMM DD, yyyy HH:mm:ss a");
            String dateToDisplay = dateFormatter.format(dateObject);
            String url = prop.getString("url");
            EarthQuakeData dataEarthquake=new EarthQuakeData(prop.getDouble("mag"),prop.getString("place"),dtime,url);
            earthquakes.add(dataEarthquake);
        }
